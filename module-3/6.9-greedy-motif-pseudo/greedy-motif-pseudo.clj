...
;(prn (get-probs-map [(vec (str "ACGT")) (vec (str "TTTT"))] 3))
...
;(prn (compute-profile [(vec (str "ACCT")) (vec (str "TTTT"))]))
(prn (compute-profile [(vec (str "ACCT"))]))
(prn (compute-profile [(vec (str "ACCT")) (vec (str "ATGT"))]))
